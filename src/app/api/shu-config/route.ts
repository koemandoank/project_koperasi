  ...
  try {
    ...
    await prisma.auditLog.create({
      data: {
        ...
        old_values: (oldConfig ?? {}) as Parameters<typeof prisma.auditLog.create>[0]["data"]["old_values"],
        new_values: body as Parameters<typeof prisma.auditLog.create>[0]["data"]["new_values"],
