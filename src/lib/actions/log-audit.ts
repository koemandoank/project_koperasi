  ...
  try {
    ...
    await prisma.auditLog.create({
      data: {
        ...
        old_values: (params.oldValues ?? null) as Parameters<typeof prisma.auditLog.create>[0]["data"]["old_values"],
        new_values: (params.newValues ?? null) as Parameters<typeof prisma.auditLog.create>[0]["data"]["new_values"],
